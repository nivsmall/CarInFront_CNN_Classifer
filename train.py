...
def train(tfrecord_path, transfer=False):
    ...
    val_ds = input_pipeline.read_tfrecord('bdd100k/tfrecords/val_highway.tfrecords', show=False)
    ...
    plot_training_session(history, lr, drop_out, batchNorm, val_loss, val_acc, )
